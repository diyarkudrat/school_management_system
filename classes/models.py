...
class Assignment(models.Model):
    ...
    slug = models.CharField(max_length=30, blank=True, editable=False,
    ...
    earned_points = models.PositiveIntegerField(blank=True, null=True, default=0)
    ...
    def get_absolute_url(self):
        """ Returns a fully-qualified path for an assignment """
        path_components = {'slug': self.slug}
        return reverse('course-list', kwargs=path_components)
...
class Course(models.Model):
    ...
    def save(self, *args, **kwargs):
        """ Creates a URL safe slug automatically when a new a course is created. """
        if not self.pk:
