...
urlpatterns = [
        ...
        path('grades/courses/', views.CourseListView.as_view(), name="course-list"),
        ...
        path('<str:slug>/assignment/grade/', views.AssignmentGradeView.as_view(), name="grade-assignment-page")
